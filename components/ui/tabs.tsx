...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-lg bg-white/5 p-1 text-muted-foreground border border-white/10",
      className
    )}
    {...props}
  />
